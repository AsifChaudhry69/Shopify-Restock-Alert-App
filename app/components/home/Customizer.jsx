...
import { Label, ColorRow, SliderRow, TextRow, SelectRow, Divider } from "./CustomizerControls";
...
export function Customizer({ showCustomizer, setShowCustomizer, activeTab, setActiveTab, settings, setSettings, saved, setSaved, onReset, onSave }) {
  return (
    <>
      {showCustomizer && (
